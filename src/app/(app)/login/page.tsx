...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-svh items-center justify-center px-4">
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-primary/[0.05] to-transparent hidden dark:block"
        aria-hidden
      />

      <div className="w-full max-w-sm animate-fade-in-up">
        {/* Card */}
        <div className="relative overflow-hidden rounded-2xl border bg-card/80 p-8 backdrop-blur-xl shadow-xl dark:shadow-primary/5 dark:border-primary/10">
          {/* Top accent line */}
          ...
          <div className="mb-8 flex flex-col items-center gap-3">
            <span className="flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-amber-600 text-primary-foreground shadow-lg shadow-primary/25 dark:shadow-primary/20">
